...
#import "PHRootListViewController.h"
...
@interface PHRootListViewController () <PHPhotoLibraryChangeObserver>
@property (nonatomic, strong) NSArray *sectionFetchResults;
@property (nonatomic, strong) NSArray *sectionLocalizedTitles;
@end

@implementation PHRootListViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    /*
        Get the PHAssetGridViewController being pushed and the UITableViewCell
        that triggered the segue.
     */
    if (![segue.destinationViewController isKindOfClass:[PHAssetGridViewController class]] || ![sender isKindOfClass:[UITableViewCell class]]) {
        return;
    }
    
    PHAssetGridViewController *assetGridViewController = segue.destinationViewController;
    UITableViewCell *cell = sender;
    
    // Set the title of the PHAssetGridViewController.
    ...
    if ([segue.identifier isEqualToString:AllPhotosSegue]) {
        ...
        // Configure the PHAssetGridViewController with the asset collection.
